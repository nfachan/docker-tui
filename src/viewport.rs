...
impl Viewport {
    ...
    pub fn change_num_containers_and_selection(
        &mut self,
        num_containers: usize,
...
mod tests {
    ...
    #[case(viewport!(0, 0, 0, 0), 0, None, viewport!(0, 0, 0, 0))]
    #[case(viewport!(0, 0, 0, 1), 0, None, viewport!(0, 0, 0, 1))]
    ...
    #[case(viewport!(2, 0, 0, 1), 0, None, viewport!(0, 0, 0, 1))]
    #[case(viewport!(2, 1, 1, 1), 0, None, viewport!(0, 0, 0, 1))]
    #[case(viewport!(2, 0, 0, 2), 0, None, viewport!(0, 0, 0, 2))]
    #[case(viewport!(2, 1, 0, 2), 0, None, viewport!(0, 0, 0, 2))]
    #[case(viewport!(2, 0, 0, 3), 0, None, viewport!(0, 0, 0, 3))]
    ...
    #[case(viewport!(3, 2, 2, 0), 0, None, viewport!(0, 0, 0, 0))]
    #[case(viewport!(3, 0, 0, 1), 0, None, viewport!(0, 0, 0, 1))]
    #[case(viewport!(3, 1, 1, 1), 0, None, viewport!(0, 0, 0, 1))]
    #[case(viewport!(3, 2, 2, 1), 0, None, viewport!(0, 0, 0, 1))]
    #[case(viewport!(3, 0, 0, 2), 0, None, viewport!(0, 0, 0, 2))]
    #[case(viewport!(3, 1, 0, 2), 0, None, viewport!(0, 0, 0, 2))]
    #[case(viewport!(3, 1, 1, 2), 0, None, viewport!(0, 0, 0, 2))]
    #[case(viewport!(3, 2, 1, 2), 0, None, viewport!(0, 0, 0, 2))]
    #[case(viewport!(3, 0, 0, 3), 0, None, viewport!(0, 0, 0, 3))]
    #[case(viewport!(3, 1, 0, 3), 0, None, viewport!(0, 0, 0, 3))]
    ...
    fn change_num_containers_and_selection(
        ...
        #[case] new_selection: Option<usize>,
        #[case] after: Viewport,
    ) {
        before.change_num_containers_and_selection(num_containers, new_selection);
        assert_eq!(before, after);
    }
